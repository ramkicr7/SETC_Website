...
export const schemaTypes = [
  ...
  { name: 'enquiry', title: 'Enquiry / Lead', type: 'document', orderings: [{ title: 'Newest first', name: 'createdAtDesc', by: [{ field: 'createdAt', direction: 'desc' }] }], fields: [{ name: 'name', title: 'Full name', type: 'string', validation: (Rule: any) => Rule.required() }, { name: 'email', type: 'string', validation: (Rule: any) => Rule.required() }, { name: 'phone', type: 'string' }, { name: 'whatsapp', type: 'string' }, { name: 'enquiryType', type: 'string' }, { name: 'preferredService', title: 'Interested in', type: 'string' }, { name: 'message', type: 'text', rows: 5 }, { name: 'cv', title: 'CV / Resume', type: 'file' }, { name: 'sourcePage', type: 'string' }, { name: 'status', type: 'string', options: { list: ['New', 'Contacted', 'In Progress', 'Qualified', 'Converted', 'Closed', 'Spam'] }, initialValue: 'New' }, { name: 'createdAt', type: 'datetime', readOnly: true }, { name: 'updatedAt', type: 'datetime', readOnly: true }, { name: 'notes', title: 'Internal notes', type: 'text', rows: 5 }] },
];
